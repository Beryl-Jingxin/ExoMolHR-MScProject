...
# Set AlH information for HITRAN format since this molecule is not listed in
# HITRAN online table. We set its molecule number to be 50 and its isotopolugue
# number to be 1. Set its fractional abundances of iso-slug to be 1 as well.
path_mol_iso_list = ['AlH/27Al-1H/AlHambra']
hitran_online = pd.DataFrame()
hitran_online['molecule ID'] = ['50']
hitran_online['isotopologue ID'] = ['1']
hitran_online['exomol formula'] = ['27AlH']
...
states_col_name = (['ID','energy','g_tot','J_tot','Unc']
                   + ['tau','+/-','e/f','State','v','Lambda','Sigma','Omega','Ecalc','m'])
