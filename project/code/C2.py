...
# which saved the URLs with molecule, iso-slug and isotopologue. Combine them with '/' for
# reading files from folders more convenient later.
molecule = []
iso_slug = []
isotopologue = []
path_mol_iso = []
...
# HITRAN online website. It will help us to get their corresponding molecule numbers,
# isotopologue numbers and fractional abundances.
...
# Set C2 information for HITRAN format since this molecule is not listed in HITRAN online table.
# We set its molecule number to be 51 and its isotopolugue number to be 1.
